        ...
        <form action="{{route('admin.projects.store')}}" method="POST" class="text-white text-center" enctype="multipart/form-data" novalidate>
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    ...
                    <textarea class="form-control" id="description" rows="3" placeholder="Inserisci la descrizione del progetto" name="description" required></textarea>
                </div>

                <div class="col-6 mb-3">
                    <label for="full_code" class="form-label"> Full Code </label>
                    <input type="url" class="form-control" id="full_code" placeholder="Inserisci l'url al codice intero" name="full_code" required>
                </div>

                <div class="col-6 mb-3">
                    <label for="techonologies_used" class="form-label">Technologies used </label>
                    <input type="text" class="form-control" id="techonologies_used" placeholder="Inserisci le tecnologie utilizzate" name="techonologies_used" required>
                </div>
        </div>
